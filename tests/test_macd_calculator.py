...
from utils.macd_calculator import MACDCalculator, calculate_macd, get_macd_last
...
class TestMACDCalculator:
    ...
    def test_macd_upward_trend(self):
        ...
        macd_line, signal_line, histogram = calculator.calculate(prices)
        last_macd, last_signal, last_hist = calculator.get_last_values(prices)
    ...
    def test_get_last_values_method(self):
        """Test get_last_values method returns correct types"""
...
class TestConvenienceFunctions:
    ...
    def test_get_macd_last_function(self):
        ...
        calculator = MACDCalculator(fast_window=5, slow_window=10, signal_window=3)
        last_class = calculator.get_last_values(prices)
