这个文档整理了项目中mongodb常用命令，方便后续使用。

``` shell
# 查询数据库版本
mongosh "mongodb://127.0.0.1:27017/technical_analysis" --eval "db.version()"

# 删除normalizer集合
mongosh "mongodb://127.0.0.1:27017/technical_analysis" --eval "db.normalizer.deleteMany({})"

# 删除features_prediction集合
